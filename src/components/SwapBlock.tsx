...
import { useSwapGemsToGold } from '@/hooks/useContractWrite';
import { formatNumber, calculateTheory } from '@/utils/calculations';
import { useState, useEffect } from 'react';
import { BSC_EXPLORER } from '@/config/contract';
...
export function SwapBlock() {
  ...
  const { swap, hash, isPending, isConfirming, isConfirmed, isError, error, reset } = useSwapGemsToGold();
      ...
      <div className="card-content">
        ...
        {gemsAmount > 0 && !inputError && (
          <div className="preview-box mb-4">
            ...
            <div className="preview-row">
              <span>Получите:</span>
              <span className="text-gold-400">{formatNumber(goldGain)} Серебро</span>
            </div>
